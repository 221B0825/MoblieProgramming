  ...
  return (
    <SafeAreaView style={ProfileStyle.container}>
      ...
      <SafeAreaView style={ProfileStyle.subContainer}>
        ...
        <Text style={ProfileStyle.showText}>가나다</Text>
      </SafeAreaView>
      <SafeAreaView style={ProfileStyle.subContainer}>
        <Text style={ProfileStyle.subText}>이메일</Text>
        <Text style={ProfileStyle.showText}>ganada@gmail.com</Text>
      </SafeAreaView>
      <SafeAreaView style={ProfileStyle.subContainer}>
        <Text style={ProfileStyle.subText}>동네 정보</Text>
        <Text style={ProfileStyle.showText}>독일 어딘가</Text>
      </SafeAreaView>

      <SafeAreaView style={ProfileStyle.subContainer}>
        <Text style={ProfileStyle.text}>나의 이력서</Text>
        <SafeAreaView style={basicStyle.row}>
          <Text style={[ProfileStyle.showText, { width: 150 }]}>
            이력서제목.pdf
          </Text>
      ...
      <TouchableOpacity onPress={editUser} style={ProfileStyle.button}>
        <Text style={basicStyle.buttonText}>내 정보 변경하기</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={withdrawalUser} style={ProfileStyle.button}>
